...
- **Next.js only**: generate `components/PushProvider.tsx` (or `.jsx`) — a `'use client'` wrapper ready to drop into your layout
...
The generated `src/NotificationHandler/config.ts` looks like:
